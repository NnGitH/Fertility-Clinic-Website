...
use MoSMCP\Common\Services\Abilities\Abilities;
...
class Hooks {
	...
	public static function init() {
		...
		// Register the plugin's own abilities (create/update post) with the Abilities API.
		add_action( 'wp_abilities_api_categories_init', array( Abilities::class, 'register_categories' ) );
	...
	public static function ensure_authorization_htaccess() {
		...
		} elseif ( ! is_writable( dirname( $htaccess ) ) ) {
			return;
		}
